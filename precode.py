...
from pyspark.sql.functions import from_json, to_json, col, struct, current_timestamp, unix_timestamp, current_date
from pyspark.sql.types import StructType, StructField, StringType, LongType
import psycopg2

DDL = 'CREATE TABLE IF NOT EXISTS public.subscribers_feedback (\
  id serial4 NOT NULL,\
...
TOPIC_NAME = 'student.topic.cohort5.pinochel'
OUT_TOPIC_NAME = 'student.topic.cohort5.pinochel.out'
...
def restaurant_read_stream(spark: SparkSession):
...
def subscribers_restaurant_df(spark: SparkSession):
